...
public class IParam implements java.lang.Cloneable, java.io.Serializable
{
    ...
    public IParam(String token, String json, String[] arrays, byte[] bytes, int pageIndex, int pageNumber, String extend)
    {
        this.token = token;
        this.json = json;
        this.arrays = arrays;
    ...
    public static final long serialVersionUID = 2023754656L;
}
